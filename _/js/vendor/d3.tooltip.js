    ...
    d3.selection.prototype.tooltip = function(o, f) {
      ...
      return this.each(function(d, i) {
        ...
        move_tip = function(selection) {
          ...
          setTimeout(function() {
            return selection.style("left", "" + center[0] + "px").style("top", "" + center[1] + "px").style("display", "block").style("width","" + options.width + "px").style("height","" + options.height + "px");
          }, 300);
        };
        el.on("mouseover", function() {
          ...
          if (options.type === "popover") {
            inner = tip.append("div").attr("class", "popover-inner").style("font-size", "" + options.fontsize + "px").style("line-height", "1.3em");
          ...
          inner.append("div").attr("class", "popover-content").html(options.content);
          }
